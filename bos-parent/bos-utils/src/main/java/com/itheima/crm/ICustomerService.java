...
public interface ICustomerService {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "findCustomerByTel", targetNamespace = "http://service.crm.itheima.com/", className = "com.itheima.crm.FindCustomerByTel")
    @ResponseWrapper(localName = "findCustomerByTelResponse", targetNamespace = "http://service.crm.itheima.com/", className = "com.itheima.crm.FindCustomerByTelResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "findNoAssCustomer", targetNamespace = "http://service.crm.itheima.com/", className = "com.itheima.crm.FindNoAssCustomer")
    @ResponseWrapper(localName = "findNoAssCustomerResponse", targetNamespace = "http://service.crm.itheima.com/", className = "com.itheima.crm.FindNoAssCustomerResponse")
    public List<Customer> findNoAssCustomer();
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "findAssCustomer", targetNamespace = "http://service.crm.itheima.com/", className = "com.itheima.crm.FindAssCustomer")
    @ResponseWrapper(localName = "findAssCustomerResponse", targetNamespace = "http://service.crm.itheima.com/", className = "com.itheima.crm.FindAssCustomerResponse")
    public List<Customer> findAssCustomer(
        @WebParam(name = "arg0", targetNamespace = "")
        String arg0);
