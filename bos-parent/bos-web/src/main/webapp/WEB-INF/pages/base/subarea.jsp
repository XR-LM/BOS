...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<!-- 添加 修改分区 -->
	<div class="easyui-window" title="显示区域分布图" id="showSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div split="false" border="false" id="test">
