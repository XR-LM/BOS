...
<script type="text/javascript">
	...
	function doAssociations(){
		...
		if(rows.length!=1){
			...
			//发送ajax请求，请求定区Action,在定区Action中通过crm代理对象完成对于crm服务的远程调用获取客户数据
			var url_1="decidedzoneAction_findNoAssCustomer.action";
			...
			var url_2 = "decidedzoneAction_findAssCustomer.action";
	...
	function doDblClickRow(index,data){
		...
		$('#association_customer').datagrid( {
			...
			rownumbers : true,
			striped : true,
			url : "decidedzoneAction_findAssCustomer.action?Id="+data.id,
			columns : [[{
				field : 'id',
				title : '客户编号',
				width : 120,
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="关联客户窗口" id="customerWindow" collapsible="false" closed="true" minimizable="false" maximizable="false" style="top:20px;left:200px;width: 400px;height: 300px;">
		<div style="overflow:auto;padding:5px;" border="false">
		<form id="customerForm" action="${pageContext.request.contextPath }/decidedzoneAction_assCustomer.action" method="post">
				<table class="table-edit" width="80%" align="center">
					<tr class="title">
